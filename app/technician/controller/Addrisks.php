...
class Addrisks
{
    public function index()
    {
        ...
        if(!isset($_POST['staffid']) || !isset($token) || !isset($_POST['job_id']) || !isset($_POST['job_type']) || !isset($_POST['add_ids']) ){
            return json($result); 
        }
        if(empty($_POST['staffid']) || empty($token) || empty($_POST['job_id']) || empty($_POST['job_type']) || empty($_POST['add_ids'])){
            return json($result); 
        }
        //获取信息
