...
class imageTool
{
      ...
      */ 
      ...
      { 
            ...
            $points = array(); 
            for($x = $p; $x < ($this->img_w)/10; $x+= $this->horizontal)
            { 
                  if($x > $max_x)
                  { 
                        $max_x = $x; 
            ...
            switch ($this->all_config['draw_type'])
            {
                  ...
                  { 
                        ...
                        # 绘制水印
                        $res = imagettftext($img, $this->font_size, $this->all_config['rotate_angle'], $m['x'], $m['y'], $wm_color, 
            ...
            imagedestroy($img);
            return $this->all_config['draw_bg'];
